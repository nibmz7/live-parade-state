 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function ze(e){let t=Ge.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},Ge.set(e.type,t));let i=t.stringsArray.get(e.strings);if(void 0!==i)return i;const s=e.strings.join(ue);return i=t.keyString.get(s),void 0===i&&(i=new fe(e,e.getTemplateElement()),t.keyString.set(s,i)),t.stringsArray.set(e.strings,i),i}const Ge=new Map,Fe=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`,_t=(e,t)=>{let i=(null==t?void 0:t.autoBlur)||!0,s=(null==t?void 0:t.debounce)||!0,r=!1;return t=>{if(r)return;if(s&&(r=!0,setTimeout(()=>r=!1,1e3)),i){t.currentTarget.blur()}let o=t.type;if("click"===o)e(t);else if("keydown"===o){let i=t.key;"Enter"!==i&&" "!==i||e(t)}}},Ot=new WeakMap,It=_e(e=>t=>{const i=Ot.get(t);if(void 0===e&&t instanceof Ae){if(void 0!==i||!Ot.has(t)){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else e!==i&&t.setValue(e);Ot.set(t,e)});var Nt;!function(e){e[e.PENDING=0]="PENDING",e[e.INVALID=1]="INVALID",e[e.VALID=2]="VALID"}(Nt||(Nt={}));const Dt=()=>({value:"",validity:Nt.PENDING}),Rt=()=>({value:"",validity:Nt.PENDING,visible:!1}),kt=e=>t=>{let i=t.target,s=i.value,r=Nt.PENDING;s.length>0&&(r=i.validity.valid?Nt.VALID:Nt.INVALID),e({value:s,validity:r})},Tt=(e,t,i,s)=>{const r=(null==s?void 0:s.placeholder)||"",o=(null==s?void 0:s.label)||"";return He`
    ...
    />
  `},Pt=(e,t,i,s)=>{const r=_t(()=>i({...e,visible:!e.visible}),{autoBlur:!1,debounce:!1});return He`
  ...
  `};var Ut=function(e,t,i,s){var r,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(o<3?r(n):o>3?r(t,i,n):r(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let $t=class extends gt{constructor(){super(...arguments),this.errorMessage="",this.errorVisible=!1,this.isProcessing=!1,this.emailState=Dt(),this.passwordState=Rt(),this.onSubmit=_t(e=>{if(e.preventDefault(),this.emailState.validity!==Nt.VALID)return void this.showError("Please enter a valid email address!");if(this.passwordState.validity!==Nt.VALID)return void this.showError("Please enter a valid password!");if(this.isProcessing)return;this.isProcessing=!0;let t={email:this.emailState.value,password:this.passwordState.value},i=re.requestSignIn(t);w.dispatch(i)})}connectedCallback(){super.connectedCallback();w.listen(y.AUTH,(e,t)=>{if(e.action.type===te.REQUEST_SIGN_IN_FAILED){let t=e.action.payload;this.isProcessing=!1,this.showError(t.message)}else e.action.type===te.SIGNED_IN&&(t(),this.successfullLogin())}),window.PasswordCredential&&navigator.credentials.get({password:!0,mediation:"required"}).then(e=>{if(e){let t=e;this.emailState.value=t.id,this.passwordState.value=t.password}})}successfullLogin(){if(window.PasswordCredential){var e=new window.PasswordCredential({id:this.emailState.value,password:this.passwordState.value});navigator.credentials.store(e)}let t=new Event("signed-in");this.dispatchEvent(t)}showError(e){this.errorMessage=e,this.errorVisible=!0}render(){return He`
    ...
    />
  `}
          ${Pt(this.passwordState,()=>{this.passwordState={...this.passwordState,validity:Nt.PENDING},this.errorVisible=!1},e=>this.passwordState=e,e=>this.onSubmit(e))}
    ...
    `;var e,t,i}static get styles(){return[vt,wt,St,xt,Et,mt`
      ...
      `]}};Ut([nt({type:String})],$t.prototype,"errorMessage",void 0),Ut([nt({type:Boolean})],$t.prototype,"errorVisible",void 0),Ut([nt({type:Boolean})],$t.prototype,"isProcessing",void 0),Ut([nt({type:Object})],$t.prototype,"emailState",void 0),Ut([nt({type:Object})],$t.prototype,"passwordState",void 0),$t=Ut([rt("login-view")],$t);var At,Ct=function(e,t,i,s){var r,o=arguments.length,n=o<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(o<3?r(n):o>3?r(t,i,n):r(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};!function(e){e[e.OPENING=0]="OPENING",e[e.OPENED=1]="OPENED",e[e.CLOSING=2]="CLOSING",e[e.STALLING=3]="STALLING"}(At||(At={}));let Mt=class extends gt{constructor(){super(...arguments),this.state=At.OPENING,this.closePrompt=!1}firstUpdated(){let e=()=>{this.state===At.OPENING?this.state=At.OPENED:this.state===At.CLOSING&&(this._dialog.removeEventListener("animationend",e),this.dispatchEvent(new Event("close",{bubbles:!0,composed:!0})))};this._dialog.addEventListener("animationend",e)}reset(){this.dispatchEvent(new Event("reset"))}close(){this.state===At.STALLING?(this.closePrompt=!0,this.reset()):this.state===At.OPENED&&(this.state=At.CLOSING)}render(){return He`<div
      tabindex="0"
      id="root"
      class="selectable"
      ?hide="${this.state===At.CLOSING}"
      ?show="${this.state===At.OPENING}"
      ?ready="${this.state===At.OPENED||this.state===At.STALLING}"
    ...
    >
      <div
        ...
        class="dialog card"
        aria-label="Dialog"
        @click="${e=>{if(e.stopPropagation(),this.state===At.STALLING&&window.offsetOn){if(e.composedPath()[0].tagName.toLowerCase().includes("input"))return;this.reset()}}}"
      >
        <slot></slot>
    ...
    >
      <div id="root" tabindex="0" class="selectable">
        ...
        <div id="rankname" class="row-box">
          ${Tt(this.rankState,()=>{this.rankState={...this.rankState,validity:Nt.PENDING},this.onInputFocus()},e=>{let t=T.isValid(e.value.toUpperCase());e.validity===Nt.PENDING||t||(e.validity=Nt.INVALID),this.rankState=e},{placeholder:"Rank",label:"Rank",id:"rank",changeText:e=>e.replace(/\W/g,"")})}
          ${Tt(this.nameState,()=>{this.nameState={...this.nameState,validity:Nt.PENDING},this.onInputFocus()},e=>this.nameState=e,{placeholder:"Name",label:"Name",id:"name"})}
        </div>

        <div id="email" class="row-box">
          ${Tt(this.emailState,()=>{this.emailState={...this.emailState,validity:Nt.PENDING},this.onInputFocus()},e=>this.emailState=e,{placeholder:"Email",label:"Email",changeText:e=>e.replace(/\W/g,"")})}

          <p>@${this.branch.domain}</p>
        </div>

        <div id="password" class="row-box">
          ${Pt(this.passwordState,()=>{this.passwordState={...this.passwordState,validity:Nt.PENDING},this.onInputFocus()},e=>this.passwordState=e,()=>{})}
    ...
    >
      <div id="root" tabindex="0" class="selectable">
        ...
        ${Tt(this.nameState,()=>this.onInputFocus(),e=>{this.nameState=e},{placeholder:"e.g. Log Branch",label:"Department name"})}
 ...
 */})}
    ...
    `}static get styles(){return[bt,mt`
      ...
      `]}};ki([at("#root")],Ti.prototype,"_root",void 0),ki([nt({type:Boolean,reflect:!0})],Ti.prototype,"splashscreen",void 0),ki([nt({type:Boolean,reflect:!0})],Ti.prototype,"initialized",void 0),ki([nt({type:Number})],Ti.prototype,"viewType",void 0),ki([nt({type:Boolean})],Ti.prototype,"visible",void 0),Ti=ki([rt("view-switcher")],Ti)}]);