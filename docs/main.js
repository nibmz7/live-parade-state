 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Wt=(e,t)=>{const r=e.startNode.parentNode,i=void 0===t?e.endNode:t.startNode,s=r.insertBefore(ve(),i);r.insertBefore(ve(),i);const o=new Ce(e.options);return o.insertAfterNode(s),o},Yt=(e,t)=>(e.setValue(t),e.commit(),e),Zt=(e,t,r)=>{const i=e.startNode.parentNode,s=r?r.startNode:e.endNode,o=t.endNode.nextSibling;o!==s&&ce(i,t.startNode,o,s)},Jt=e=>{pe(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},Xt=(e,t,r)=>{const i=new Map;for(let s=t;s<=r;s++)i.set(e[s],s);return i},Kt=new WeakMap,er=new WeakMap,tr=_e((e,t,r)=>{let i;return void 0===r?r=t:void 0!==t&&(i=t),t=>{if(!(t instanceof Ce))throw new Error("repeat can only be used in text bindings");const s=Kt.get(t)||[],o=er.get(t)||[],n=[],a=[],d=[];let l,c,p=0;for(const t of e)d[p]=i?i(t,p):p,a[p]=r(t,p),p++;let u=0,h=s.length-1,m=0,f=a.length-1;for(;u<=h&&m<=f;)if(null===s[u])u++;else if(null===s[h])h--;else if(o[u]===d[m])n[m]=Yt(s[u],a[m]),u++,m++;else if(o[h]===d[f])n[f]=Yt(s[h],a[f]),h--,f--;else if(o[u]===d[f])n[f]=Yt(s[u],a[f]),Zt(t,s[u],n[f+1]),u++,f--;else if(o[h]===d[m])n[m]=Yt(s[h],a[m]),Zt(t,s[h],s[u]),h--,m++;else if(void 0===l&&(l=Xt(d,m,f),c=Xt(o,u,h)),l.has(o[u]))if(l.has(o[h])){const e=c.get(d[m]),r=void 0!==e?s[e]:null;if(null===r){const e=Wt(t,s[u]);Yt(e,a[m]),n[m]=e}else n[m]=Yt(r,a[m]),Zt(t,r,s[u]),s[e]=null;m++}else Jt(s[h]),h--;else Jt(s[u]),u++;for(;m<=f;){const e=Wt(t,n[f+1]);Yt(e,a[m]),n[m++]=e}for(;u<=h;){const e=s[u++];null!==e&&Jt(e)}Kt.set(t,n),er.set(t,d)}});var rr=function(e,t,r,i){var s,o=arguments.length,n=o<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(n=(o<3?s(n):o>3?s(t,r,n):s(t,r))||n);return o>3&&n&&Object.defineProperty(t,r,n),n};const ir=(e,t)=>e===y.USERS?t.payload.fullname:t.payload.name;let sr=class extends gt{constructor(){super(...arguments),this.requests={},this.dateStoreListener=async e=>{if(!k.includes(e.action.type))return;const t=e.action.type,r=e.action,i=I[t],s=e.action.root,o=s===y.USERS?"user":"department";let n,a,d=void 0,l=void 0;if(r.type===_.REQUEST_SUCCESSFUL){const e=r.payload,t=I[e.type-3];a=`${o} '${ir(s,e)}' ${t} ${i}!`,n=e.id}else if(r.type===_.REQUEST_ERROR){const e=r.payload,t=e.action;a=`${i} ${I[t.type]} ${o} '${ir(s,t)}'`,n=t.id,l=t.payload,d=e.message}else{a=`${i} ${o} '${ir(s,r)}'...`,n=r.id}n=`request-${n}`,this.requests={...this.requests,[n]:{id:n,root:s,type:t,message:a,payload:l,error:d}}}}connectedCallback(){super.connectedCallback(),this.departmentsUnsubscribe=w.listen(y.DEPARTMENTS,this.dateStoreListener),this.usersUnsubscribe=w.listen(y.USERS,this.dateStoreListener)}disconnectedCallback(){var e,t;super.disconnectedCallback(),null===(e=this.departmentsUnsubscribe)||void 0===e||e.call(this),null===(t=this.usersUnsubscribe)||void 0===t||t.call(this)}onDismiss(e){return _t(()=>{const t=this.shadowRoot.getElementById(e);t.addEventListener("animationend",()=>{const{[e]:t,...r}=this.requests;this.requests=r},{once:!0}),t.style.animation="item-appear-out .3s"})}render(){const e=Qe`<div id="root">
 ...
 */})}
    ...
    `}static get styles(){return[...super.styles,mt`
      ...
      `]}};ur=pr([st("admin-user-list")],ur);var hr=function(e,t,r,i){var s,o=arguments.length,n=o<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(n=(o<3?s(n):o>3?s(t,r,n):s(t,r))||n);return o>3&&n&&Object.defineProperty(t,r,n),n};let mr=class extends gt{constructor(){super(...arguments),this.showAddDepartment=!1}onAddDepartment(){return _t(()=>{this.showAddDepartment=!0})}closeAddDepartment(){this.showAddDepartment=!1}render(){return Qe`<div id="root">
      ...
      `]}};fr([nt({type:Number})],gr.prototype,"index",void 0),fr([nt({type:Object})],gr.prototype,"department",void 0),fr([nt({type:Object})],gr.prototype,"selectedUser",void 0),fr([nt({type:Boolean})],gr.prototype,"isMorning",void 0),fr([nt({type:Boolean})],gr.prototype,"isEmpty",void 0),fr([nt({type:Object})],gr.prototype,"presentCount",void 0),gr=fr([st("user-dep-item")],gr);var yr=function(e,t,r,i){var s,o=arguments.length,n=o<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,r,i);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(n=(o<3?s(n):o>3?s(t,r,n):s(t,r))||n);return o>3&&n&&Object.defineProperty(t,r,n),n};let vr=class extends nr{constructor(){super(...arguments),this.isMorning=!0,this.depItemTemplate=(e,t)=>Qe`<user-dep-item
      .index="${t}"
      .department="${e}"
      .isMorning="${this.isMorning}"
