 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Re=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:e=>e}),Ue=` ${ue} `;class ke{constructor(e,t,i,s){this.strings=e,this.values=t,this.type=i,this.processor=s}getHTML(){const e=this.strings.length-1;let t="",i=!1;for(let s=0;s<e;s++){const e=this.strings[s],r=e.lastIndexOf("\x3c!--");i=(r>-1||i)&&-1===e.indexOf("--\x3e",r+1);const o=ve.exec(e);t+=null===o?e+(i?Ue:he):e.substr(0,o.index)+o[1]+o[2]+"$lit$"+o[3]+ue}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");let t=this.getHTML();return void 0!==Re&&(t=Re.createHTML(t)),e.innerHTML=t,e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
  ...
  `}
    ...
    >
      <div id="root" tabindex="0" class="selectable">
        ...
        <div id="rankname" class="row-box">
          ${kt(this.rankState,()=>{this.rankState={...this.rankState,validity:Nt.PENDING},this.onInputFocus()},e=>{let t=k.isValid(e.value.toUpperCase());e.validity===Nt.PENDING||t||(e.validity=Nt.INVALID),this.rankState=e},{placeholder:"Rank",label:"Rank",id:"rank",changeText:e=>e.replace(/\W/g,"")})}
          ${kt(this.nameState,()=>{this.nameState={...this.nameState,validity:Nt.PENDING},this.onInputFocus()},e=>this.nameState=e,{placeholder:"Name",label:"Name",id:"name"})}
        </div>

        <div id="email" class="row-box">
          ${kt(this.emailState,()=>{this.emailState={...this.emailState,validity:Nt.PENDING},this.onInputFocus()},e=>this.emailState=e,{placeholder:"Email",label:"Email",changeText:e=>e.replace(/\W/g,"")})}
    ...
    >
      <div id="root" tabindex="0" class="selectable">
        ...
        ${kt(this.nameState,()=>this.onInputFocus(),e=>{this.nameState=e},{placeholder:"e.g. Log Branch",label:"Department name"})}
 ...
 */})}
    ...
    `}static get styles(){return[bt,mt`
      ...
      `]}};Ui([at("#root")],ki.prototype,"_root",void 0),Ui([nt({type:Boolean,reflect:!0})],ki.prototype,"splashscreen",void 0),Ui([nt({type:Boolean,reflect:!0})],ki.prototype,"initialized",void 0),Ui([nt({type:Number})],ki.prototype,"viewType",void 0),Ui([nt({type:Boolean})],ki.prototype,"visible",void 0),ki=Ui([rt("view-switcher")],ki)}]);